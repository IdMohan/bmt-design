  ...
  (e.fn.attr2 = function () {
    ...
    (e.fn.ajaxSubmit = function (a) {
      ...
      var n,
        ...
        s,
        u = this;
      "function" == typeof a ? (a = { success: a }) : void 0 === a && (a = {}),
              ...
              ? (function (t) {
                  ...
                  return (
                    (s.beforeSend = function (e, t) {
                      a.formData ? (t.data = a.formData) : (t.data = r),
                        u && u.call(this, e, t);
                    }),
                    e.ajax(s)
                  );
      ...
      function k(t) {
        ...
        if (
          (((c = e.extend(!0, {}, e.ajaxSettings, a)).context = c.context || c),
          ...
          (l = c.global) && 0 == e.active++ && e.event.trigger("ajaxStart"),
        ...
        function A() {
          var t = u.attr2("target"),
            r = u.attr2("action"),
            a =
              u.attr("enctype") || u.attr("encoding") || "multipart/form-data";
          y.setAttribute("target", f),
            (n && !/post/i.test(n)) || y.setAttribute("method", "POST"),
        ...
        k && D && ((c.extraData = c.extraData || {}), (c.extraData[k] = D)),
        ...
        function O(t) {
          if (!h.aborted && !M) {
            if (
              ((E = S(d)) || (i("cannot access response document"), (t = w)),
              t === j && h)
            )
            ...
            if ((E && E.location.href != c.iframeSrc) || x) {
              ...
              try {
                ...
                (h.responseText = o ? o.innerHTML : null),
                  (h.responseXML = E.XMLDocument ? E.XMLDocument : E),
                  n && (c.dataType = "xml"),
              ...
              h.aborted && (i("upload aborted"), (a = null)),
                h.status &&
                  (a =
                    (h.status >= 200 && h.status < 300) || 304 === h.status
                      ...
                      : "error"),
                "success" === a
                  ? (c.success && c.success.call(c.context, L, "success", h),
                    T.resolve(h.responseText, "success", h),
                    l && e.event.trigger("ajaxSuccess", [h, c]))
                  : a &&
                    (void 0 === r && (r = h.statusText),
                    c.error && c.error.call(c.context, h, a, r),
                    T.reject(h, "error", r),
                    l && e.event.trigger("ajaxError", [h, c, r])),
                ...
                setTimeout(function () {
                  c.iframeTarget ? p.attr("src", c.iframeSrc) : p.remove(),
                    (h.responseXML = null);
                }, 100);
            }
          }
    ...
    (e.fn.formToArray = function (r, a) {
      ...
      if (
        (h && !/MSIE [678]/.test(navigator.userAgent) && (h = e(h).get()),
        d &&
      ...
      for (o = 0, f = h.length; o < f; o++)
        if ((u = (l = h[o]).name) && !l.disabled)
          if (r && p.clk && "image" == l.type)
            p.clk == l &&
              (n.push({ name: u, value: e(l).val(), type: l.type }),
              n.push(
    ...
    e(f).each(function () {
      ...
      if (
        ...
        if (h.allowParentLinks && !h.nestedParentLinks && i)
          ...
          e(o)
            ...
            .parent()
            .addClass(s + "_row");
        h.showChildren ? t.addClass(s + "_open") : t.addClass(s + "_collapsed"),
      ...
      e(i.btn).keydown(function (t) {
        ...
        switch (n.keyCode) {
          ...
          case o:
            t.preventDefault(),
              (n.keyCode === o && e(i.btn).hasClass(s + "_open")) ||
                i._menuToggle(),
        ...
        switch ((t || event).keyCode) {
          ...
          case p:
            t.preventDefault(),
              e(t.target)
                .parent()
                .hasClass(s + "_collapsed") && i._itemClick(e(t.target)),
          ...
          case c:
            if (
              ...
              e(t.target)
                .parent()
                .parent()
                .hasClass(s + "_nav") && (i._menuToggle(), e(i.btn).focus());
            break;
          case r:
      ...
      a && (p = r.duration),
        t.hasClass(s + "_hidden")
          ? (t.removeClass(s + "_hidden"),
            o || r.beforeOpen(i),
            "jquery" === r.animations
              ? t.stop(!0, !0).slideDown(p, r.easingOpen, function () {
                  d(i, n);
                })
    ...
    return (
      ...
      this.each(function () {
        ...
        if (void 0 === s) {
          ...
          var i =
            n.offset + (a.offset().top - e(window).scrollTop()) * (1 - n.speed);
          a.css({
            "background-image": s,
