...
$(document).ready(function () {
	...
	$(document).ready(function () {
		function startSlider() {
			$('.customer-logos').append($('.customer-logos').html()); // Duplicate slides for smooth transition
			let slideWidth = $('.customer-logos .slide').outerWidth(true);
			let totalWidth = $('.customer-logos .slide').length * slideWidth;
			$('.customer-logos').css('width', totalWidth);

			function animateSlider() {
				$('.customer-logos').animate({ left: -slideWidth }, 4500, "linear", function () {
					$('.customer-logos .slide:first').appendTo('.customer-logos');
					$('.customer-logos').css('left', 0);
					animateSlider();
				});
			}
			animateSlider();
